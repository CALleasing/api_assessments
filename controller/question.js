...
exports.getStaffQuestionByNumber = (req, res, next) => {
  ...
  questionsModel
    .queryStaffQuestionByNumber({ year, part, number })
    .then(([row]) => {
      res.send(row);
    })
    .catch((error) => {
...
exports.getManagerQuestionByNumber = (req, res, next) => {
  const { year, part, number } = req.params;
  questionsModel
    .queryManagerQuestionByNumber({ year, part, number })
    .then(([row]) => {
      res.send(row);
    })
    .catch((error) => {
...
exports.getStaffCommentByNumber = (req, res, next) => {
  const { year, part, number } = req.params;
  questionsModel
    .queryStaffCommentByNumber({ year, part, number })
    .then(([row]) => {
      res.send(row);
    })
    .catch((error) => {
...
exports.postOrPutStaffQuestion = (req, res, next) => {
  ...
  questionsModel
    ...
    .then(([row]) => {
      if (row.length !== 0) {
        questionsModel
          .updateStaffQuestion({ year, part, number, question })
          .then(() => {
            res.status(201).json({
        ...
        questionsModel
          .insertStaffQuestion({ year, part, number, question })
          .then(() => {
            res.status(201).json({
...
exports.postOrPutManagerQuestion = (req, res, next) => {
  ...
  questionsModel
    ...
    .then(([row]) => {
      if (row.length !== 0) {
        questionsModel
          .updateManagerQuestion({ year, part, number, question })
          .then(() => {
            res.status(201).json({
              message: "success",
            });
        ...
        questionsModel
          .insertManagerQuestion({ year, part, number, question })
          .then(() => {
            res.status(201).json({
              message: "success",
            });
...
exports.postOrPutStaffComment = (req, res, next) => {
  ...
  questionsModel
    ...
    .then(([row]) => {
      if (row.length !== 0) {
        questionsModel
          .updateStaffComment({ year, part, number, question })
          .then(() => {
            res.status(201).json({
              message: "update success",
            });
        ...
        questionsModel
          .insertStaffComment({ year, part, number, question })
          .then(() => {
            res.status(201).json({
              message: "insert success",
            });
...
exports.deleteStaffQuestionByNumber = (req, res, next) => {
  const { year, part, number } = req.params;
  questionsModel
    .deleteStaffQuestionByNumber({ year, part, number })
    .then(([row]) => {
      res.send(row);
    })
    .catch((error) => {
...
exports.deleteManagerQuestionByNumber = (req, res, next) => {
  const { year, part, number } = req.params;
  questionsModel
    .deleteManagerQuestionByNumber({ year, part, number })
    .then(([row]) => {
      res.send(row);
    })
    .catch((error) => {
...
exports.deleteStaffCommentByNumber = (req, res, next) => {
  const { year, part, number } = req.params;
  questionsModel
    .deleteStaffCommentByNumber({ year, part, number })
    .then(([row]) => {
      res.send(row);
    })
    .catch((error) => {
